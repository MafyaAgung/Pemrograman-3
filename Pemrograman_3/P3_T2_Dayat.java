...
public class P3_T2_Dayat {
    public static void main(String[] args) {
        ...
        System.out.print("Anwar     : Masukan Jumlah Data : ");
        n = input.nextInt();
        System.out.println("-------------------------------------------------------");
        System.out.println();
        input.nextLine();
        ...
        int[][] nil =new int[n][2];
        for( int i = 0; i < n; i++ ){
            System.out.print("Anwar     : Mata Kuliah = ");
            nama[i]=input.nextLine();
            System.out.print("Anwar     : Nilai Teori = ");
            nil[i][0]=input.nextInt();
            System.out.print("Anwar     : Nilai Pratikum = ");
